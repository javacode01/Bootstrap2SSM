...
<link rel="stylesheet" href="${r"${basepath}"}resource/bootstrap_treeview/bootstrap-treeview.css">
<style>
...
<body>
	...
	<script src="${r"${basepath}"}resource/bootstrap_treeview/bootstrap-treeview.js"></script>
